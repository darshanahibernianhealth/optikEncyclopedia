...
?>
      <!-- content-wrapper ends -->
        ...
        <!-- main-panel ends -->
        <div id="refreshBody" style="visibility:none;"></div>
      </div>
...
// alert('hiii');
        ...
        $(document).on('click', '.trashMail', function(){
          ...
          $.ajax({
               url: "<?= base_url('trash'); ?>",
                method:"GET",
                data:{"mail_conversation_id":conversation_id, "mail_status" : "deleted", "mail_flag" : "","useremail" : useremail},
                dataType: "json",
                success:function(data)
                { 
                  // alert(data);
                            ...
                            // console.log('formattedDate==' + formattedDate);
                               ...
                               $('#searchMailBodyTr').append("<tr class='w-100' style='cursor: pointer; border-bottom: solid 1px lightgrey; '>"+
                                  ...
                                  " <td class='listMailDetails inboxMailId' relid='"+val.mail_id+"'>"+
                                    "<span>"+
                                      "<p class='pClass' id='mail_name_clor' style='color:"+mailbox_color+"'>"+(val.mail_from_name).substring(0,20)+"</p>"+
                                    "</span>"+
                                    "<span>"+

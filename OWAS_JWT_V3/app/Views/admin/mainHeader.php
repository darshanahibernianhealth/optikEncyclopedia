     ...
     <!--  <li class="nav-item dropdown">
      ...
      <!-- Notifications Dropdown Menu -->
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="<?php echo base_url('changeEmail'); ?>" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> Changes Email
      ...
      <!-- <li class="nav-item">
        <a href="<?php echo base_url('logout'); ?>" class="nav-link" role="button">
